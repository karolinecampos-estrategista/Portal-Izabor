...
const PRODUTOS = [
  {
    ...
    emoji: "👑",
    cor: "#C9A84C",
    descricao: "Mentoria intensiva — transformação profunda em identidade, fé e liderança com a Izabor Cruz. Um programa completo com aulas exclusivas, plano de ação personalizado e acompanhamento contínuo.",
    detalhes: [
  ...
  },
  {
    ...
    emoji: "💜",
    cor: "#a78bfa",
    descricao: "Comunidade mensal de mulheres extraordinárias com encontros ao vivo, sessões individuais com a Izabor, estudos e suporte contínuo mês a mês.",
    detalhes: [
